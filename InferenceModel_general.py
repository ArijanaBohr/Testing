...
# In[1]:
import sys
#modelpath example: model_path="saved_polynomial_TestingV2tflite_keras.tflite"
def run_inference_polynomial_TestingV2(model_path, topredict):
    import numpy as np
...
if __name__ == '__main__':
    ...
    run_inference_polynomial_TestingV2(sys.argv[1], sys.argv[2])
